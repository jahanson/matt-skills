This is a fork of the original repository. Do not automate upstream changes. Code stays here, no PR to upstream.
...
Every shell script also has an adjacent Deno TypeScript alternative. See [.agents/deno-scripts.md](./.agents/deno-scripts.md) for commands, permissions, dependencies, and parity checks.
