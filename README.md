...
- **[wizard](./skills/engineering/wizard/SKILL.md)**: Generate an interactive Bash or Deno wizard that walks a human through steps only they can perform: provisioning infrastructure, setting up credentials or CI secrets, walking an unfamiliar third-party dashboard, or running a one-off migration or cutover.
